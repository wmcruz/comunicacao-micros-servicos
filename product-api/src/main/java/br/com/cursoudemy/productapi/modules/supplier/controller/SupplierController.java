...
public class SupplierController {
    ...
    public SupplierResponse update(@RequestBody SupplierRequest supplierRequest, @PathVariable Integer supplierId) {
        return this.supplierService.update(supplierRequest, supplierId);
    }
